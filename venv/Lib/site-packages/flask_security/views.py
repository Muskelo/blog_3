...
def login():
    ...
    return _security.render_template(config_value('LOGIN_USER_TEMPLATE'),
                                     login_user_form=form,access=access,
                                     **_ctx('login'))
...
def register():
    ...
    return _security.render_template(config_value('REGISTER_USER_TEMPLATE'),
                                     register_user_form=form,access=access,
                                     **_ctx('register'))
...
def send_login():
    ...
    return _security.render_template(config_value('SEND_LOGIN_TEMPLATE'),
                                     send_login_form=form,access=access,
                                     **_ctx('send_login'))
...
def send_confirmation():
    ...
    return _security.render_template(
        config_value('SEND_CONFIRMATION_TEMPLATE'),access=access,
...
def forgot_password():
    ...
    return _security.render_template(config_value('FORGOT_PASSWORD_TEMPLATE'),
                                     forgot_password_form=form,access=access,
...
def reset_password(token):
    ...
    return _security.render_template(
        ...
        reset_password_form=form,access=access,
...
def change_password():
    ...
    return _security.render_template(
        ...
        change_password_form=form,access=access,
